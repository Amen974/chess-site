...
const Square = ({
  ...
  isLastMove,
  isNewGame,
}: { piece: Piece | null, color: string, id: string, onDrop: (id: string) => void, onDragStart: (id: string) => void, onClick: (id: string) => void, isSelected: boolean, isLegalMove: boolean, isLastMove: boolean, isNewGame: boolean }) => {
