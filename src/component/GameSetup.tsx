...
const GameSetup = ({ onStart, handelClose }: {onStart: (args: { mode: Mode; difficulty: Difficulty; side: Side }) => void, handelClose: () => void }) => {
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex gap-2">
              {levels.map(({ label, depth }) => (
                <button
                  key={depth}
                  onClick={() => setDifficulty(depth as Difficulty)}
